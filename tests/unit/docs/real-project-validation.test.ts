...
describe('real project validation log', () => {
  it('records five representative projects with outcomes and follow-ups', () => {
    ...
    expect(content.match(/- Check outcome:/g)).toHaveLength(5);
    expect(content.match(/- False positives:/g)).toHaveLength(5);
