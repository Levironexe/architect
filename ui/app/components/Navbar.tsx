  ...
  return (
    ...
    <nav className="flex items-center justify-between py-6 max-w-280 mx-auto w-full">
      ...
      <div className="hidden md:flex items-center space-x-8 text-sm font-medium">
        ...
        <a href="#" className="text-dark hover:text-muted transition-colors">Registry</a>
      </div>
      <a
        href="https://github.com/Levironexe/architect"
        target="_blank"
        className="inline-flex items-center gap-2 bg-dark text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-gray-800 transition-colors"
      >
